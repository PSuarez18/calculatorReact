        ...
        <div>
          ...
          <div className="button-container">
            <div className="number-buttons">
              <button onClick={() => numberButtonClick('7')} className="button number">
                <Icon icon="material-symbols:counter-7" height={45} />
              </button>
              <button onClick={() => numberButtonClick('8')} className="button number">
                <Icon icon="material-symbols:counter-8" height={45} />
              </button>
              <button onClick={() => numberButtonClick('9')} className="button number">
                <Icon icon="material-symbols:counter-9" height={45} />
              </button>
              <button onClick={() => numberButtonClick('4')} className="button number">
                <Icon icon="material-symbols:counter-4" height={45} />
              </button>
              <button onClick={() => numberButtonClick('5')} className="button number">
                <Icon icon="material-symbols:counter-5" height={45} />
              </button>
              <button onClick={() => numberButtonClick('6')} className="button number">
                <Icon icon="material-symbols:counter-6" height={45} />
              </button>
              <button onClick={() => numberButtonClick('1')} className="button number">
                <Icon icon="material-symbols:counter-1" height={45} />
              </button>
              <button onClick={() => numberButtonClick('2')} className="button number">
                <Icon icon="material-symbols:counter-2" height={45} />
              </button>
              <button onClick={() => numberButtonClick('3')} className="button number">
                <Icon icon="material-symbols:counter-3" height={45} />
              </button>
              <button onClick={() => handlerClear()} className="button clear">
                <Icon icon="material-symbols:copyright-outline-rounded" height={45} />
              </button>
              <button onClick={() => numberButtonClick('0')} className="button number">
